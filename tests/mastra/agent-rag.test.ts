...
describe('RoboRail RAG Integration', () => {
  it('should have the correct system prompt', () => {
  ...
  it('should have a properly configured RAG tool', () => {
  ...
  it('should have proper RAG tool structure for AI SDK', () => {
  ...
  it('should validate RAG tool parameters correctly', () => {
